# yingya
映芽 · Yingya，对话式动画视频制作工作台，把内容做成会动的视频。

面向产品营销、内容运营和知识创作者，将文案、网页、截图、图片及已有视频编排为
产品演示、知识动画、数据故事和品牌短片。通过对话确认方案、预览与局部修改，
再导出 MP4；项目保留可编辑的 HyperFrames 源文件与草稿版本。

产品定位与能力边界见 [产品定位](docs/PRODUCT_POSITIONING.md)。
