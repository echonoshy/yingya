...
- `yingya-intro-v2.mp4`：历史首页宣传片，来自项目 `11f96954-9d29-41b2-b068-a87701b005d6` 的草稿二导出 `draft-2-landscape-4k-60fps-e3aa8f79-ed59-4a63-a546-a0467ea06a8f.mp4`。保留完整 65.83 秒内容与配音，由 4K／60 fps 转为 1080p／60 fps、H.264（CRF 23）+ AAC（160 kbps），启用 MP4 faststart，约 4.7 MB。对应封面 `yingya-intro-v2.jpg` 取自成片第 64.5 秒。项目中的原始导出保留不变；网页使用独立公共副本，无需登录。
