...
function currentRoute(){return window.location.pathname === '/prototype-home' ? 'prototype' : /^\/admin(?:\/|$)/.test(window.location.pathname)?'admin':isWorkspaceRoute()?'workspace':'marketing';}
