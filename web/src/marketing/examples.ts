...
export const featuredLeft: VideoExample = { id: 'warm-grain', title: '给品牌，一点温度', category: '品牌短片', description: '柔和配色、纸张质感与简洁图形。', prompt: '用我提供的品牌文案和素材，制作一支 15 秒的品牌动效短片。采用柔和绿色与米白色、轻微纸张质感和简洁图形，突出一句核心主张，最后呈现品牌名称。先确认文案与制作方案。', source: 'HyperFrames 官方示例' };
...
const galleryExamples: VideoExample[] = [
  ...
  { id: 'kinetic-type-hd', title: '让讲解，多一层表达', category: '知识动画', description: '人物讲解与动态图文结合，让重点随讲述展开。', prompt: '在我提供的人物讲解视频上添加动态图文。保留原始人物画面和声音，用关键词、图形与字幕突出重点，保持内容准确。先确认需要强调的段落与视觉方案。', source: 'HyperFrames 官方示例' },
