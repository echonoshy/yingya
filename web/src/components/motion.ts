...
export function animateElement(element: HTMLElement, keyframes: Keyframe[], durationToken = "--motion-standard", easingToken = "--ease-sprout") {
  ...
  const animation = element.animate(keyframes, { duration, easing: styles.getPropertyValue(easingToken).trim(), fill: "none" });
